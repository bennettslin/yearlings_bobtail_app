    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(DevSongsField, {
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    annotationIsShown ? React.createElement(
                        'div',
                        { key: 'annotation', id: 'annotation', className: 'notes-row annotation-row' },
                        React.createElement(DevAnnotationField, {
            ...
            playedSongIndex >= 0 ? React.createElement(
                'div',
                { className: 'dev-app-column lyrics-column' },
                React.createElement(DevLyricsField, {
...
var DevLyricsColumn = React.createClass({
    ...
    render: function () {
        var columnIndex = this.props.columnIndex,
            columnTitleHeader = this.props.columnTitle ? React.createElement(
            'h3',
            null,
            ...
            lyricsTextArea = React.createElement(
            'div',
...
var DevLyricsField = React.createClass({
    ...
    render: function () {
        ...
        lyricsColumns = filteredLyricsColumnKeys.map(function (key, index) {
            return React.createElement(DevLyricsColumn, {
                key: key,
                columnIndex: key,
...
var DevProgressBar = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement('div', { className: 'filled-progress-bar', style: filledStyle })
        );
    }
});
var DevProgressField = React.createClass({
    ...
    _getProgressBar: function (task) {
        return React.createElement(DevProgressBar, {
            sumTask: task,
    ...
    _getTaskSubrow: function (task, taskIndex, isSubtask) {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                task.neededHours ? React.createElement(
                    'span',
    ...
    render: function () {
        ...
        taskRows = tasks.map(function (task, taskIndex) {
        ...
        }, this), sumTask = ProgressManager.calculateSumTask(tasks), taskFooter = React.createElement(
            'div',
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'dev-task-text-wrapper' },
                    React.createElement('span', { className: 'task-placeholder' }),
                    sumTask.neededHours ? React.createElement(
                        'h3',
                        { className: 'text-cell progress' },
                        sumTask.workedHours,
                        '/',
...
var DevSongRow = React.createClass({
    ...
    _getFooterContent: function (sumTask) {
        return React.createElement(
            'div',
            { className: 'dev-song-text-wrapper' },
            React.createElement('span', { className: 'button-placeholder' }),
            React.createElement(
                'h3',
                { className: 'text-cell progress' },
                sumTask.workedHours,
    ...
    render: function () {
        var sumTask = this.props.sumTask,
            ...
            progressBar = !this.props.isHeader && !this.props.isFooter ? React.createElement(DevProgressBar, {
            sumTask: sumTask,
...
var DevSongsField = React.createClass({
    ...
    render: function () {
        var songs = this.props.songs,
            songsHeader = React.createElement(DevSongRow, { key: 'header', isHeader: true }),
            ...
            return React.createElement(DevSongRow, {
                key: songIndex,
                songIndex: songIndex,
            ...
            songsFooter = React.createElement(DevSongRow, { key: 'footer', isFooter: true, sumTask: sumAllTasks });
