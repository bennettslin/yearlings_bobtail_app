The thing that indie rock cares about, the thing that distinguishes indie rock from just plain rock, is a luxury good. We don't want to see artists enduring real-life hardships, making real-world sacrifices, to build up indie cred. We would find such stories depressing, not uplifting. Building up a grassroots following from the ground up means playing weeknight shows in neighbouring towns hours away, where no one's heard of you and there's no guarantee you'll even have an audience. Because deep down, we know that it has no intrinsic value. We give it its value.
