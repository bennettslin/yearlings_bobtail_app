...
const LYRIC = 'lyric',
    ...
    DOUBLE_COLUMN_STATIC_BREAKPOINT = 20 * APP_ICON_DIAMETER + 10 * NAV_BOOK_PADDING + NAV_LAST_TITLE_MARGIN + DOUBLE_COLUMN_UNITS,
    DOUBLE_COLUMN_SHRINK_BREAKPOINT = 20 * SHRINK_ICON_DIAMETER + 10 * NAV_BOOK_PADDING + NAV_LAST_TITLE_MARGIN + DOUBLE_COLUMN_UNITS,
    SINGLE_COLUMN_STATIC_BREAKPOINT = 11 * APP_ICON_DIAMETER + 8 * NAV_BOOK_PADDING + NAV_LAST_TITLE_MARGIN + SINGLE_COLUMN_UNITS,

    DOTS_TIPS_WIDTH = 2 * APP_LARGE_ICON_DIAMETER + 2 * DOTS_TIPS_PADDING + DOTS_TIPS_MARGIN,
    DOTS_TIPS_TABLET_WIDTH = 2 * APP_TABLET_LARGE_ICON_DIAMETER + 2 * DOTS_TIPS_PADDING + DOTS_TIPS_MARGIN,
    DOTS_TIPS_MINI_WIDTH = 2 * APP_MINI_LARGE_ICON_DIAMETER + 2 * DOTS_TIPS_PADDING + DOTS_TIPS_MARGIN,
    ...
    MINI_WIDTH_OBJECT = {
        ...
        dotsTipsInMainBreakpoint: AUDIO_MIN_WIDTH + 2 * (DOTS_TIPS_MINI_WIDTH)
    },
    TABLET_WIDTH_OBJECT = {
        ...
        dotsTipsInMainBreakpoint: AUDIO_MIN_WIDTH + 2 * (DOTS_TIPS_TABLET_WIDTH),
    },
    LAPTOP_WIDTH_OBJECT = {
        className: 'laptop-width',
        maxWidth: 1400,
        doubleColumnStaticBreakpoint: DOUBLE_COLUMN_STATIC_BREAKPOINT + UNCANNY_VALLEY_WIDTH + APP_LARGE_ICON_DIAMETER,
        doubleColumnShrinkBreakpoint: DOUBLE_COLUMN_SHRINK_BREAKPOINT + UNCANNY_VALLEY_WIDTH + APP_LARGE_ICON_DIAMETER,
        singleColumnStaticBreakpoint: SINGLE_COLUMN_STATIC_BREAKPOINT + UNCANNY_VALLEY_WIDTH + APP_LARGE_ICON_DIAMETER,
        dotsTipsInMainBreakpoint: AUDIO_MIN_WIDTH + 2 * (DOTS_TIPS_WIDTH) + UNCANNY_VALLEY_WIDTH
    },
    MONITOR_WIDTH_OBJECT = {
        className: 'monitor-width',
        doubleColumnStaticBreakpoint: DOUBLE_COLUMN_STATIC_BREAKPOINT + GOLDEN_CORD_WIDTH + APP_LARGE_ICON_DIAMETER,
        doubleColumnShrinkBreakpoint: DOUBLE_COLUMN_SHRINK_BREAKPOINT + GOLDEN_CORD_WIDTH + APP_LARGE_ICON_DIAMETER,
        singleColumnStaticBreakpoint: SINGLE_COLUMN_STATIC_BREAKPOINT + GOLDEN_CORD_WIDTH + APP_LARGE_ICON_DIAMETER,
        dotsTipsInMainBreakpoint: AUDIO_MIN_WIDTH + 2 * (DOTS_TIPS_WIDTH) + GOLDEN_CORD_WIDTH
    }
