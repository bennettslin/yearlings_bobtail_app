...
const LYRIC = 'lyric',
    ...
    MINI_OBJECT = {
        ...
        scoresTipsOutsideMenuBreakpoint: DOTS_TIPS_IN_MAIN_CONSTANT + 2 * MENU_SUBFIELD_NARROW_MARGIN + 3 * APP_MINI_LARGE_ICON_DIAMETER,
    ...
    TABLET_OBJECT = {
        ...
        scoresTipsOutsideMenuBreakpoint: DOTS_TIPS_IN_MAIN_CONSTANT + 2 * MENU_SUBFIELD_MARGIN + 3 * APP_TABLET_LARGE_ICON_DIAMETER
    },
    LAPTOP_OBJECT = {
        ...
        scoresTipsOutsideMenuBreakpoint: DOTS_TIPS_IN_MAIN_CONSTANT + 2 * MENU_SUBFIELD_NARROW_MARGIN + UNCANNY_VALLEY_WIDTH + 3 * APP_LARGE_ICON_DIAMETER
    },
    MONITOR_OBJECT = {
        ...
        scoresTipsOutsideMenuBreakpoint: DOTS_TIPS_IN_MAIN_CONSTANT + 2 * MENU_SUBFIELD_MARGIN + GOLDEN_CORD_WIDTH + 3 * APP_LARGE_ICON_DIAMETER
    }
