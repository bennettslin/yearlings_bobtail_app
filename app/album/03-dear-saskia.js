module.exports = {
    ...
    overviews: {
        ...
        music: `As a kid, I marvelled at the Beatles for weaving melodies and chords so seamlessly. This song began as an overzealous attempt to match them in form and style. In the end, it suffered from overthinking, and I put it away in disgust. Years later, I realised that its overwrought nature was exactly what my letter to Sasha called for, and trotted it back out. The passive-aggressive lyrics are matched in texture by screeching woodwinds and scratch tones on violins.`
    },
    lyrics: [
        [
            [
