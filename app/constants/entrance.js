...
const GENERAL_BUFFER_DURATION = 25
const CONVERTED_CURTAINS_TRANSITION_DURATION =
    convertToMilliseconds(TRANSITION_DURATION_CURTAINS)

/**
 * This timeout allows the curtains to close completely, making the transition
 * between songs less janky.
 */
export const CURTAINS_DID_CLOSE_AFTER_SONG_CHANGE_BEGAN_DURATION = 50
...
export const STAGE_DID_RESET_AFTER_STAGE_COULD_RESET_DURATION = 150
