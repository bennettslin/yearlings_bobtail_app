...
export const MARKETING_RETURN_BUTTON_KEY = 'marketingReturn'
...
export const PITCH_HOME_BUTTON_KEY = 'pitchHome'
export const PITCH_PREVIOUS_BUTTON_KEY = 'pitchPrevious'
export const PITCH_NEXT_BUTTON_KEY = 'pitchNext'
export const PITCH_SEGMENT_BUTTON_KEY = 'pitchSegment'
