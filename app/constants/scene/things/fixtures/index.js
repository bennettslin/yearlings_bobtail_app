...
export const BEDROOM_LAMP__DESK_ON = 'bedroomLamp__deskOn'
...
export const USED_CONDOM_LIZ = 'usedCondomLiz'
export const USED_CONDOM_MIRIAM = 'usedCondomMiriam'
export const USED_CONDOM_REFLECTION = 'usedCondomReflection'
