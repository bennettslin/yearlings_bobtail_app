...
export const DRUMS_STACKED_BASEMENT = 'drumsStacked__basement'
export const DRUMS_STACKED_CLUB = 'drumsStacked__club'
export const CAVEMAN_BONES = 'cavemanBones'
export const PUSH_BROOM_BACKSTAGE = 'pushBroom__backstage'
export const PUSH_BROOM_TUNNEL = 'pushBroom__tunnel'
...
export const STAGE_MIC_SIDE_CROWD = 'stageMicSide__crowd'
export const STAGE_MIC_SIDE_STAGE = 'stageMicSide__stage'
