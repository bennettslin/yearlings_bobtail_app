...
export const PAINTING_FUXI = 'paintingFuxi'
export const PAINTING_FUXI__MAT = 'paintingFuxi__mat'
export const PAINTING_FUXI__STAIRS = 'paintingFuxi__stairs'
export const PAINTING_NUWA = 'paintingNuwa'
export const PAINTING_NUWA__MAT = 'paintingNuwa__mat'
export const PAINTING_NUWA__STAIRS = 'paintingNuwa__stairs'
