...
export default [
    ...
    },
    {
        ...
        text: [
            ...
            `This is why we have the word "startup," to remind us that startups are their own thing. They're not simply stores that are more risky due to being less competent. A startup comes with more risk precisely because it aims to fulfill an unknown need. But if it succeeds, then it becomes the leader of a new market. And for investors, this means a greater reward.`
        ],
    ...
    },
    {
        ...
        text: [
            `If an artup isn't capable of winning over a thousand fans on their own, why should we think that label support could help them gain a million? One reason is that artups can benefit from the network effect.`,
            `For example, James Joyce's Ulysses.`
        ],
    ...
    },
    {
        ...
        text: [
            `If you've already checked out our audio webcomic, then maybe you know where this is going. Yearling's Bobtail is both a difficult and a complex work, so it's an artup.`
        ],
