                ...
                },
                {
                    ...
                    lyric: [
                        ...
                        `with your`,
                        {
                            ...
                            card: {
                                description: [
                                    `Like many other Taiwanese teenagers of her generation, my mother prized all things labeled American, despite not knowing exactly what that meant. Back then, their only access was through a local bootleg industry that recycled the relics of America's past. And so my sister and I grew up listening to my mother's old country records and sharing her fondness for classic Western movies.`,
                                ],
                                dotKeys: {
                                    [BACKSTORY]: true,
                                },
