            ...
            mainVerses: [
                {
                    ...
                    lyric: [
                        `till then`,
                        {
                            ...
                            card: {
                                description: `A friend once told me that if I can keep a woman cracking up at my jokes, then I'll always be good for another date. Unfortunately, my humor at the time was based on clever puns, given Catherine's fondness for them— and puns tend to draw groans from most everyone else.`,
                                dotKeys: {
                                    [BACKSTORY]: true,
                                    [PUN]: true,
                                },
