    ...
    lyricUnits: [
        ...
        },
        {
            ...
            unitDot: {
                anchor: IS_UNIT_DOT,
                card: {
                    description: `Sasha recited these lines for me over the phone. We tried several takes because she found it hard to portray them as snippets of actual conversation. I had to admit to her that I didn't write them with this concern in mind.`,
                    dotKeys: {
                        [BACKSTORY]: true,
                        [SONGCRAFT]: true,
                    },
                        ...
                        },
                        {
                            ...
                            card: {
                                description: [
                                    ...
                                    `, the paramilitary group responsible for carrying out the Holocaust, wore an insignia consisting of two thunderbolts side by side. But as for me— wishing no more to strike at anyone with my thunder— I strike myself down instead, leaving my ego behind.`,
                                ],
                                dotKeys: {
                                    [NARRATIVE]: true,
                                    [OBSERVATION]: true,
            ...
            mainVerses: [
                {
                    ...
                    lyric: [
                        `"So all your`,
                        {
                            ...
                            card: {
                                description: `For years, my habit was to stay with Sita right up till I had another option to pursue. Each time, she'd languish for a few months before mustering the courage to contact me; then, upon hearing that things hadn't worked out with the other woman, she'd cajole me back. But now our situations were reversed: I had no further options coming down the pike, while she'd fallen in love with someone else.`,
                                dotKeys: {
                                    [BACKSTORY]: true,
                                },
                            },
