                ...
                },
                {
                    ...
                    lyricCentre: [
                        `safely kept with`,
                        {
                            ...
                            card: {
                                description: `The less I spent on food in those days, the more I had left over to spend on beer. So before leaving the cafeteria, I'd swipe a couple of bread rolls and stash them in the front pockets of my jacket.`,
                                dotKeys: {
                                    [BACKSTORY]: true,
                                },
                            },
            ...
            unitDot: {
                ...
                card: {
                    description: [
                        ...
                        `. However, these harmonics ranged from the fifth to the twelfth fret, and I just couldn't move my hand up and down the neck quickly enough. As a result, I still had to record the part in multiple takes.`,
                    ],
                    dotKeys: {
                        [SONGCRAFT]: true,
                    },
