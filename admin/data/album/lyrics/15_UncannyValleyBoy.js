        ...
        },
        {
            ...
            unitDot: {
                ...
                cards: [
                    ...
                    {
                        description: [
                            `After Ana and Joi left the band, it didn't feel right to keep referring to myself as the Yearlings. On top of that, with the Internet gaining in usage, I wanted a new name that'd always be first in search results. So I decided to combine two random words… but all I could think of was "Bobtail Yearlings"… which, for symmetry's sake, would make the album "`,
                            {
                                isItalic: true,
