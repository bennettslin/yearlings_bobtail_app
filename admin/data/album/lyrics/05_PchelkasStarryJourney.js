            ...
            unitDot: {
                ...
                card: {
                    description: [
                        ...
                        `. This took Catherine by total surprise, and thus impressed her to no end; we became an item soon after. I've been following the same playbook to win over every new crush since.`,
                    ],
                    dotKeys: {
                        [BACKSTORY]: true,
                        [SONGCRAFT]: true,
