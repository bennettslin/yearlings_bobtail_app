                        ...
                        `who shrug when thus annoyed, yawning, "`,
                        {
                            ...
                            card: {
                                description: [
                                    ...
                                    `" boys— but the one naturally follows the other. It surprised me when school aides declined to intervene on behalf of the bullied, as if doing so would disturb the natural order of the middle school ecosystem.`,
                                ],
                                dotKeys: {
                                    [OBSERVATION]: true,
                                    [PUN]: true,
