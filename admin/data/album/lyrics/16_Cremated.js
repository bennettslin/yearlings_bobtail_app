...
export default {
    ...
    todo: REVIEW,
    overview: `If I'm to be honest, then yes, dating White women did help to subdue my lifelong feeling of genetic inferiority— but I really didn't seek them out. A case in point is Miriam, who was the storybook ending my ego had been waiting for: cute, hip, and drawn to me through no effort on my part. As it turns out, though… we only lasted a few months. I've had to wonder ever since if she was just slumming it with me.`,
                        ...
                        `not`,
                        {
                            ...
                            card: {
                                description: [
                                    ...
                                    `, famously didn't get along, which made for tense moments behind the scenes. Similarly, though it delighted Miriam to watch my two halves outwit each other, she surely wanted no part of the inner conflict that fueled this spectacle.`,
                                ],
                                dotKeys: {
                                    [BACKSTORY]: true,
                                    [OBSERVATION]: true,
                    ...
                    lyricRight: [
                        {
                            ...
                            card: {
                                description: [
                                    ...
                                    `. Here, then, thinking he's found another to speak for his crimes, sober me now watches in alarm as his drunken half pats him on the shoulder with a sharp sword.`,
                                ],
                                dotKeys: {
                                    [NARRATIVE]: true,
                                    [PUN]: true,
