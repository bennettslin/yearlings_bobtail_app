            ...
            mainVerses: [
                {
                    ...
                    lyric: [
                        `As`,
                        {
                            ...
                            todo: REVIEW,
                            card: {
                                description: `My brother stares out blankly with his mouth hung open— at least right up till my mother's gap-toothed "comb" starts gnawing on his scalp.`,
                                dotKeys: {
                                    [NARRATIVE]: true,
                                    [PUN]: true,
                                },
            ...
            unitDot: {
                ...
                card: {
                    description: [
                        ...
                        `. Now, as a piano student of ten years, I'd played counterpoint before; I just didn't know any theory behind it. But since it's rarely done in rock music, I realized I could simply come up with my own approach, and have this be my trademark.`,
                    ],
                    dotKeys: {
                        [SONGCRAFT]: true,
                    },
