                    ...
                    lyric: [
                        {
                            ...
                            todo: REVIEW,
                            card: {
                                description: `Earlier, we'd scavenged a few materials to make imaginary weapons, but the steam tunnels were too cramped for us to do more than brandish them. Now out in the open, "our melee tapers the discourse"— that is, the chattering stops and the battling starts— as we head back to Howie's car.`,
                                dotKeys: {
                                    [NARRATIVE]: true,
                                    [PUN]: true,
                                },
