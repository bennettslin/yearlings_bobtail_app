            ...
            mainVerses: [
                {
                    ...
                    lyric: [
                        `Oh Catherine,`,
                        {
                            ...
                            todo: REVIEW,
                            card: {
                                description: `Feeling sheepish that Catherine thought so little of my songs, I held onto the hope of writing one that could tug at her heartstrings someday. So in this scenario, I imagine myself asking her for a critique of the very lyrics you're listening to now.`,
                                dotKeys: {
                                    [BACKSTORY]: true,
                                    [NARRATIVE]: true,
                                },
                                ...
                                `Et`,
                                {
                                    ...
                                    card: {
                                        description: [
                                            ...
                                            `"— or, "Paris is well worth a Mass"— implying that his earthly ambitions preceded any spiritual allegiances. Similarly, I would've converted if that could get Catherine to stay.`,
                                        ],
                                        dotKeys: {
                                            [OBSERVATION]: true,
                                        },
