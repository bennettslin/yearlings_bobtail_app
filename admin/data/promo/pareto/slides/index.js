...
export default getFormattedSlideMetadata([
    ...
    },
    {
        ...
        footnote: [
            `More on the`,
            {
                ...
                href: `https://en.wikipedia.org/wiki/Slim_Shady_EP`,
            },
            `.`,
        ],
    },
        ...
        body: [
            {
                paragraph: [
                    ...
                    `time will be remembered, aren't chances just as good that it's presently unknown to`,
                    {
                        isEmphasis: true,
                        lyric: `us`,
                    },
            ...
            {
                paragraph: [
                    `We'll never know which work this might be, but can you think of a smarter one to bet on than`,
                    {
                        isItalic: true,
                        lyric: `Yearling's Bobtail`,
                    },
    ...
    },
    {
        ...
        body: [
            {
                paragraph: `BYCombo is our nonprofit band incubator that aims to break this vicious circle by starting a demo renaissance. To the labels, we promise that solid chunks of lifetime went into making each demo; and to the bands, we promise that every demo is given fair consideration. So labels can have a full picture of who's out there, and bands can devote time and energy to what matters.`,
            },
            {
                paragraph: [
        ...
        body: [
            ...
            },
            {
                paragraph: [
                    ...
                    `that demonstrates this theory. Once I have more resources in the future, I'll create an online tutorial, along with an app to hear music composed in this manner.`,
                ],
            },
            {
                paragraph: [
